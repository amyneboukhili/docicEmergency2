...
class ThemeUtils {
  ...
  static const primaryBlue = Color(0xff313A51);
  static const secondaryGreenBlue = Color(0xff0F818F);
  ...
  static const mov = Color(0xffCCEAEE) ;
  static const splashColorPurple = Color(0xffAC8A84);
  static const fillColorLight = Color(0xffF5F5FA);
  static const fillColorDark = Color(0xff1F222A);
  static const filleBackcolor = Color(0xff313A51);
  static const greyColorforcontainer = Color(0xffD9D9D9) ;
  static const  containerColor = Color(0xffFDFAF6) ;
